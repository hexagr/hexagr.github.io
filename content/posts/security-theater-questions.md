...
<p style="text-align: justify">
Obviously this means sometimes all that may be needed to reset a user's password is to answer a few questions which could potentially be passively gleaned from the internet or social engineering.</p>

<p style="text-align: justify">
Given that we have new generations of technologies and services that enable much safer multiple-factor authentication, it's concerning to see some organizations still using primitive security question questionnaires to authorize password resets. I think we should abandon the practice entirely.</p>
