...
We generate our encryption key using the username of the current user. If the username is less than 16 characters, we just pad it with `0x01`. We follow the conventions for using the BCrypt API from Microsoft[^4].
